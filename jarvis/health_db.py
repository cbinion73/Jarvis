...
CREATE TABLE IF NOT EXISTS daily_metrics (
    ...
    blood_oxygen        REAL,
    weight              REAL,
    -- Extended Health Auto Export metrics
    ...
    distance_km         REAL,
    mindful_min         INTEGER,
    -- Nutrition (from Apple Health dietary logs)
    dietary_protein_g   REAL,
    dietary_carbs_g     REAL,
    dietary_fat_g       REAL,
    dietary_calories    REAL,
    dietary_fiber_g     REAL,
    dietary_sugar_g     REAL,
    dietary_sodium_mg   REAL,
    water_ml            REAL,
    caffeine_mg         REAL,
    -- Metadata
    raw_json            TEXT,
...
async def _get_db():
    async with aiosqlite.connect(str(_DB_PATH)) as db:
        ...
        for col_sql in [
            ...
            # daily_metrics extended Health Auto Export columns
            "ALTER TABLE daily_metrics ADD COLUMN respiratory_rate REAL",
            "ALTER TABLE daily_metrics ADD COLUMN heart_rate_avg REAL",
            "ALTER TABLE daily_metrics ADD COLUMN walking_hr_avg REAL",
            ...
            "ALTER TABLE daily_metrics ADD COLUMN flights_climbed INTEGER",
            "ALTER TABLE daily_metrics ADD COLUMN distance_km REAL",
            "ALTER TABLE daily_metrics ADD COLUMN mindful_min INTEGER",
            "ALTER TABLE daily_metrics ADD COLUMN dietary_protein_g REAL",
            "ALTER TABLE daily_metrics ADD COLUMN dietary_carbs_g REAL",
            "ALTER TABLE daily_metrics ADD COLUMN dietary_fat_g REAL",
            "ALTER TABLE daily_metrics ADD COLUMN dietary_calories REAL",
            "ALTER TABLE daily_metrics ADD COLUMN dietary_fiber_g REAL",
            "ALTER TABLE daily_metrics ADD COLUMN dietary_sugar_g REAL",
            "ALTER TABLE daily_metrics ADD COLUMN dietary_sodium_mg REAL",
            "ALTER TABLE daily_metrics ADD COLUMN water_ml REAL",
            "ALTER TABLE daily_metrics ADD COLUMN caffeine_mg REAL",
        ]:
            try:
        ...
        await db.execute("""
            INSERT INTO daily_metrics
              (date, source, steps, resting_hr, hrv, sleep_hours, sleep_deep,
               ...
               weight, respiratory_rate, heart_rate_avg, walking_hr_avg,
               vo2_max, body_fat_pct, lean_body_mass_kg, flights_climbed,
               distance_km, mindful_min,
               dietary_protein_g, dietary_carbs_g, dietary_fat_g,
               dietary_calories, dietary_fiber_g, dietary_sugar_g,
               dietary_sodium_mg, water_ml, caffeine_mg,
               raw_json, created_at)
            VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
            ON CONFLICT(date, source) DO UPDATE SET
              ...
              exercise_min      = COALESCE(excluded.exercise_min, exercise_min),
              stand_hours       = COALESCE(excluded.stand_hours, stand_hours),
              blood_oxygen      = COALESCE(excluded.blood_oxygen, blood_oxygen),
              ...
              walking_hr_avg    = COALESCE(excluded.walking_hr_avg, walking_hr_avg),
              vo2_max           = COALESCE(excluded.vo2_max, vo2_max),
              body_fat_pct      = COALESCE(excluded.body_fat_pct, body_fat_pct),
              lean_body_mass_kg = COALESCE(excluded.lean_body_mass_kg, lean_body_mass_kg),
              flights_climbed   = COALESCE(excluded.flights_climbed, flights_climbed),
              distance_km       = COALESCE(excluded.distance_km, distance_km),
              mindful_min       = COALESCE(excluded.mindful_min, mindful_min),
              dietary_protein_g = COALESCE(excluded.dietary_protein_g, dietary_protein_g),
              dietary_carbs_g   = COALESCE(excluded.dietary_carbs_g, dietary_carbs_g),
              dietary_fat_g     = COALESCE(excluded.dietary_fat_g, dietary_fat_g),
              dietary_calories  = COALESCE(excluded.dietary_calories, dietary_calories),
              dietary_fiber_g   = COALESCE(excluded.dietary_fiber_g, dietary_fiber_g),
              dietary_sugar_g   = COALESCE(excluded.dietary_sugar_g, dietary_sugar_g),
              dietary_sodium_mg = COALESCE(excluded.dietary_sodium_mg, dietary_sodium_mg),
              water_ml          = COALESCE(excluded.water_ml, water_ml),
              caffeine_mg       = COALESCE(excluded.caffeine_mg, caffeine_mg),
              raw_json          = excluded.raw_json,
              created_at        = excluded.created_at
        """, (
            day, source,
            metrics.get("steps"), metrics.get("resting_hr"), metrics.get("hrv"),
            metrics.get("sleep_hours"), metrics.get("sleep_deep"),
            metrics.get("sleep_rem"), metrics.get("active_cal"),
            metrics.get("exercise_min"), metrics.get("stand_hours"),
            metrics.get("blood_oxygen"), metrics.get("weight"),
            metrics.get("respiratory_rate"), metrics.get("heart_rate_avg"),
            metrics.get("walking_hr_avg"), metrics.get("vo2_max"),
            metrics.get("body_fat_pct"), metrics.get("lean_body_mass_kg"),
            metrics.get("flights_climbed"), metrics.get("distance_km"),
            metrics.get("mindful_min"),
            metrics.get("dietary_protein_g"), metrics.get("dietary_carbs_g"),
            metrics.get("dietary_fat_g"), metrics.get("dietary_calories"),
            metrics.get("dietary_fiber_g"), metrics.get("dietary_sugar_g"),
            metrics.get("dietary_sodium_mg"), metrics.get("water_ml"),
            metrics.get("caffeine_mg"),
            json.dumps(metrics),
            _now(),
        ))
        await db.commit()
