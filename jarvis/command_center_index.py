    ...
    *,
    ...
    items = [
        ...
        },
        {
            ...
            "why_open": "Failure, approval, and supervision routes are useful now, but they still stop short of richer remediation, retry, and linked continuity loops.",
            ...
            "next_slice": "Add retry and remediation flows that can move from supervision or approval detail straight into recovery execution and back with explicit result continuity.",
        },
        {
...
def _seam_tracker(
    ...
    seams = [
        ...
        },
        {
            ...
            "what_became_real": "Failure and recovery now has a dedicated route with recovery detail, pending approval gates, and direct recovery-gate approval actions inside the app shell.",
            "remains_partial": "Automated remediation, richer retry workflows, and broader continuity from recovery back into affected modules still need follow-on slices.",
            "tests": [
                "tests/test_command_center_index.py",
                "tests/test_command_center_service_surface.py",
            ],
