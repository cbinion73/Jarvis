...
6. Wake word, speaker, and room inference are currently heuristic.
...
7. The perception subsystem is profile-backed, but not yet wired to physical devices.
...
8. The E14 deployment footprint is defined, but it is not yet applied to household hardware.
