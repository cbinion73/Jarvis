...
This directory is the active JARVIS canon.

Everything else was archived so the product can be viewed fresh.

## Read First

1. [JARVIS-RESCOPE-ENTRYPOINT.md](/Users/chris/Desktop/JARVIS/docs/JARVIS-RESCOPE-ENTRYPOINT.md)
2. [JARVIS-LIFE-OPERATING-OFFICER.md](/Users/chris/Desktop/JARVIS/docs/JARVIS-LIFE-OPERATING-OFFICER.md)
3. [JARVIS-SESSION-STATE.md](/Users/chris/Desktop/JARVIS/docs/JARVIS-SESSION-STATE.md)
...
Prior doctrine, phase plans, implementation maps, checklists, specs, and
trackers were moved to:

`docs/archive/2026-06-life-operating-officer-reset/`

Those files are preserved for historical reference, not active guidance.
